...
namespace NZWalks.API.Data
{
    public class NZWalksDbContext : DbContext // we are inheriting DbContext
    {
        ...
        // Seeding data into dattabase (Seeding is nothing but inserting data into database directly from here
        // It will run while we migrate
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var difficulties = new List<Difficulty>()
            {
                new Difficulty
                {
                    Id = Guid.Parse("33df2ee0-a2f1-4c3f-ba38-2b5d33572e02"),
                    Name = "Easy"
                },
                new Difficulty
                {
                    Id = Guid.Parse("35edb386-edf4-4a6b-a31b-f396eba42319"),
                    Name = "Medium"
                },
                new Difficulty
                {
                    Id = Guid.Parse("2cab0c40-42e6-4a31-ac17-ba4d2435eeb5"),
                    Name = "Hard"
                }
            };

            // Seed difficulties to the database
            // HasData -> it takes an array or list, and it will be inserted into the db
            ...
            // seed list of regions into database
